...
$.each( "touchstart touchmove touchend orientationchange tap taphold swipe swipeleft swiperight scrollstart scrollstop swipeup swipedown".split( " " ), function( i, name ) {
	$.fn[ name ] = function( fn ) {
